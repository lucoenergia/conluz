...
/**
 * Retrieves monthly Datadis production data for a community.
 *
 ...
 */
@RestController
@RequestMapping("/api/v1/communities/{communityId}/production/datadis/monthly")
public class GetDatadisMonthlyProductionController {

    private final GetDatadisProductionService getDatadisProductionService;

    public GetDatadisMonthlyProductionController(GetDatadisProductionService getDatadisProductionService) {
    ...
    @Operation(
            ...
            operationId = "getDatadisMonthlyProduction",
    ...
    public List<DatadisProduction> getDatadisMonthlyProduction(
        ...
        return getDatadisProductionService.getMonthlyProduction(communityId,
