...
@RestController
@RequestMapping("/api/v1/communities/{communityId}/production/yearly")
public class GetYearlyProductionController {
    ...
    @Operation(
            ...
            description = "Retrieves yearly energy production data for the plants of the community identified by the path "
            ...
            operationId = "getYearlyProduction"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public List<ProductionByTime> getYearlyProduction(
        ...
        if (Objects.isNull(supplyId)) {
            return getProductionService.getYearlyProductionByRangeOfDatesAndCommunity(startDate, endDate, communityId);
        }
        return getProductionService.getYearlyProductionByRangeOfDatesAndCommunityAndSupply(startDate, endDate,
