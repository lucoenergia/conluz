...
/**
 * Retrieves yearly Datadis production data for a community.
 *
 ...
 */
@RestController
@RequestMapping("/api/v1/communities/{communityId}/production/datadis/yearly")
public class GetDatadisYearlyProductionController {

    private final GetDatadisProductionService getDatadisProductionService;

    public GetDatadisYearlyProductionController(GetDatadisProductionService getDatadisProductionService) {
    ...
    @Operation(
            ...
            operationId = "getDatadisYearlyProduction",
    ...
    public List<DatadisProduction> getDatadisYearlyProduction(
        ...
        return getDatadisProductionService.getYearlyProduction(communityId,
