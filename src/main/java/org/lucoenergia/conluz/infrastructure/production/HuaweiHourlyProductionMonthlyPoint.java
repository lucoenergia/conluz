...
@Measurement(name = HuaweiConfig.HUAWEI_MONTHLY_PRODUCTION_MEASUREMENT)
public class HuaweiHourlyProductionMonthlyPoint {
     ...
     */
    public HuaweiHourlyProductionMonthlyPoint() {
    }
