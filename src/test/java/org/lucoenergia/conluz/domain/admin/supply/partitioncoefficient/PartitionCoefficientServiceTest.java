...
class PartitionCoefficientServiceTest {
    ...
    @Test
    void resolveCoefficientAtMidnightTimestamp() {
        ...
        BigDecimal result = service.resolveCoefficient(SUPPLY_ID, midnight);

        assertEquals(BigDecimal.valueOf(3.076300), result);
    }

    @Test
    void resolveCoefficientAtMidHourTimestamp() {
        ...
        BigDecimal result = service.resolveCoefficient(SUPPLY_ID, midHour);

        assertEquals(BigDecimal.valueOf(2.543200), result);
    }

    @Test
    void resolveCoefficientAtExactChangeTimestamp_returnsNewCoefficient() {
        ...
        BigDecimal result = service.resolveCoefficient(SUPPLY_ID, changeAt);

        assertEquals(BigDecimal.valueOf(4.000000), result);
    }

    @Test
    void resolveCoefficientThrowsWhenNoHistoryExists() {
        ...
        assertThrows(SupplyPartitionCoefficientNotFoundException.class,
                () -> service.resolveCoefficient(SUPPLY_ID, timestamp));
    }

    // --- resolveCoefficientsInRange ---

    @Test
    void resolveCoefficientsInRangeWithOneChange_returnsTwoTuples() {
        ...
        List<SupplyPartitionCoefficient> result = service.resolveCoefficientsInRange(SUPPLY_ID, from, to);
    ...
    @Test
    void resolveCoefficientsInRangeWithMultipleChanges_returnsNTuples() {
        Instant from = Instant.parse("2025-01-01T00:00:00Z");
    ...
    @Test
    void resolveCoefficientsInRangeFullyWithinOnePeriod_returnsOneTupleWithBoundsClipped() {
