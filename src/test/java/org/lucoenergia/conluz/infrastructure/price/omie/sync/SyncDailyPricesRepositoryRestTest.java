...
class SyncDailyPricesRepositoryRestTest extends BaseIntegrationTest {
    ...
    void syncDailyPrices_successfulResponseWithNumberOne() throws IOException {
        ...
        assertEquals(105.42, prices.get(0).getPrice());
        assertEquals(100, prices.get(1).getPrice());
        assertEquals(99.37, prices.get(2).getPrice());
        assertEquals(100, prices.get(3).getPrice());
        assertEquals(100, prices.get(4).getPrice());
        assertEquals(100, prices.get(5).getPrice());
        assertEquals(97.85, prices.get(6).getPrice());
        assertEquals(90.42, prices.get(7).getPrice());
        assertEquals(83.06, prices.get(8).getPrice());
        assertEquals(78.87, prices.get(9).getPrice());
        assertEquals(78.97, prices.get(10).getPrice());
        assertEquals(78.29, prices.get(11).getPrice());
        assertEquals(70.77, prices.get(12).getPrice());
        assertEquals(70.47, prices.get(13).getPrice());
        assertEquals(69.57, prices.get(14).getPrice());
        assertEquals(54.17, prices.get(15).getPrice());
        assertEquals(50, prices.get(16).getPrice());
        assertEquals(51, prices.get(17).getPrice());
        assertEquals(55, prices.get(18).getPrice());
        assertEquals(73.28, prices.get(19).getPrice());
        assertEquals(100.01, prices.get(20).getPrice());
        assertEquals(109.08, prices.get(21).getPrice());
        assertEquals(115.38, prices.get(22).getPrice());
        assertEquals(107.64, prices.get(23).getPrice());
