...
@Transactional
class GetYearlyProductionControllerTest extends BaseControllerTest {

    private static final String START_DATE = "2023-01-01T00:00:00.000+02:00";
    private static final String END_DATE = "2023-12-31T23:00:00.000+02:00";
    ...
    @Test
    void testGetYearlyProduction() throws Exception {
        String authHeader = loginAsCommunityMember(DEFAULT_COMMUNITY_ID);

        mockMvc.perform(get("/api/v1/communities/" + DEFAULT_COMMUNITY_ID + "/production/yearly")
    ...
    @Test
    void testGetYearlyProduction_whenPlatformAdminNotMember_thenForbidden() throws Exception {
    ...
    @Test
    void testGetYearlyProductionBySupply() throws Exception {
    ...
    @Test
    void testGetYearlyProductionByUnknownSupply() throws Exception {
    ...
    @Test
    void testGetYearlyProduction_whenNoToken_thenUnauthorized() throws Exception {
        mockMvc.perform(get("/api/v1/communities/" + DEFAULT_COMMUNITY_ID + "/production/yearly")
                        .queryParam("startDate", START_DATE)
                        .queryParam("endDate", END_DATE))
