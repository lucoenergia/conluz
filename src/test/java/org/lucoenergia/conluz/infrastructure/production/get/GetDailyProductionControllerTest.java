...
@Transactional
class GetDailyProductionControllerTest extends BaseControllerTest {
    ...
    @Test
    void testGetDailyProduction() throws Exception {
    ...
    @Test
    void testGetDailyProduction_whenPlatformAdminNotMember_thenForbidden() throws Exception {
    ...
    @Test
    void testGetDailyProductionBySupply() throws Exception {
    ...
    @Test
    void testGetDailyProductionByUnknownSupply() throws Exception {
