...
@Transactional
class DisableSupplyControllerTest extends BaseControllerTest {
    ...
    @Test
    void testDisableSupply_idempotent_whenAlreadyDisabled() throws Exception {
        String authHeader = loginAsDefaultAdmin();
    ...
    @Test
    void testDisableSupply_notFound() throws Exception {
        String authHeader = loginAsDefaultAdmin();
        UUID randomId = UUID.randomUUID();

        mockMvc.perform(post(String.format("%s/%s/disable", PATH, randomId))
                        .header(HttpHeaders.AUTHORIZATION, authHeader))
                .andDo(print())
    ...
    @Test
    void testDisableSupply_withoutToken() throws Exception {
        UUID randomId = UUID.randomUUID();
    ...
    @Test
    void testDisableSupply_withWrongToken() throws Exception {
        UUID randomId = UUID.randomUUID();
    ...
    @Test
    void testDisableSupply_authenticatedUserWithoutAdminRoleCannotAccess() throws Exception {
